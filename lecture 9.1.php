					...
					<tr>
						...
						<td>
							<select name="profession" >
								...
								<option <?php if($profession =="Teaching") echo "selected";?> >Teaching</option>
								<option <?php if($profession =="Service") echo "selected";?> >Service</option>
								<option <?php if($profession =="Business") echo "selected";?> >Business</option>
								<option <?php if($profession =="Entreprenuer") echo "selected";?> >Entreprenuer</option>
							</select> 
						</td>
