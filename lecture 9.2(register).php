			...
			<form action="" method="post">
				<table border="1">
					...
					<tr>
						<td>Hobbies: </td>
						<td>
							<input type="checkbox" value="Movies" <?php if(hobbyExists("Movies")) echo "checked";?>  name="hobbies[]"> Movies
							<input type="checkbox" value="Music" <?php if(hobbyExists("Music")) echo "checked";?> name="hobbies[]"> Music <br>
							<input type="checkbox" value="Sports" <?php if(hobbyExists("Sports")) echo "checked";?> name="hobbies[]"> Sports
							<input type="checkbox" value="Games" <?php if(hobbyExists("Games")) echo "checked";?> name="hobbies[]"> Games 
						</td>
